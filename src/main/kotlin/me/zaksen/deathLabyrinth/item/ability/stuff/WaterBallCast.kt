...
import me.zaksen.deathLabyrinth.entity.projectile.WaterBallEntity
...
class WaterBallCast: ItemAbility(
    Component.translatable("ability.waterball_cast.name"),
    Component.translatable("ability.waterball_cast.description"),
    10.0,
    1.75,
    ...
    override fun invoke(event: Event) {
        ...
        if(checkCooldown(stack)) {
            ...
            val projectile = WaterBallEntity(event.player.location.add(shotVelocity).add(0.0, 1.6, 0.0))
