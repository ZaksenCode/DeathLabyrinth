...
import me.zaksen.deathLabyrinth.entity.goal.ability.BomberThrowBombGoal
...
class BomberEntity(location: Location): Skeleton(EntityType.SKELETON, (location.world as CraftWorld).handle), Scaleable {
    ...
    init {
        this.getAttribute(Attributes.MOVEMENT_SPEED)?.baseValue = 0.31
    ...
    override fun registerGoals() {
        ...
        goalSelector.addGoal(4, BomberThrowBombGoal(this))
        goalSelector.addGoal(5, LeapAbility(this))
