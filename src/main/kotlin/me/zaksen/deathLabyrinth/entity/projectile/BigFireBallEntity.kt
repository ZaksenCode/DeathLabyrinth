...
class BigFireBallEntity(location: Location): WindCharge(EntityType.WIND_CHARGE, (location.getWorld() as CraftWorld).handle) {
    init {
    ...
    override fun explode(pos: Vec3?) {
        ...
        for (entity in entities) {
            if(owner == null) {
                ...
                EventManager.callPlayerSpellEntityDamageEvent(owner!!.bukkitEntity as org.bukkit.entity.Player, entity, 20.0, DamageType.FIRE)
            }
